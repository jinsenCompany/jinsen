            	...
            	[ 
                 ...
                 },
                 {
                     ...
                     formatter: function (cellval, row) {
                         ...
                         var  d = '<a href="salaryServlet?action=seeProduct2PriceT&creatTime=\''+ row.creatTime + '\'&projectPackageName=\''+ row.projectPackageName + '\'&cutnum=\''+ row.cutnum + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看</button></a>';
...
<div id="content">
  <div id="content-header">
    ...
    <button class="bg_lb" style="width:300px;height:60px;margin-right:65px;" type="button" onclick="window.location='productPrice2Table.jsp'"><i class="icon-dashboard"></i>详细木材生产结算台账</button>
    <button class="bg_lr" style="width:300px;height:60px;" type="button" onclick="window.location='productPrice23Table.jsp'"><i class="icon-tint"></i>分径级木材生产结算台账</button>
    </div>
           <div class="find-top1">
            <table class="bar1">
