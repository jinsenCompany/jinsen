...
<main>
    ...
    <div class="top" id="divprint">
			...
			<caption class="book_h01">录入施工方资料</caption>
				<tr>
					<td>施工方</td>
					<td><input style="border:0px;background-color: transparent;" type="text" id="ownername" name="ownername" value="" /></td>
					<td>性别</td>
					...
					<td rowspan="2"><input type="file" name="managepath" id="managepath" value="" /></td>
				</tr>
				<tr>
					<td>身份证号</td>
				...
				<tr>
					<td>总面积(亩)</td>
					<td colspan="3"><input style="width: 220px;border:0px;background-color: transparent;" type="text" id="allarea" name="allarea" value="   " /></td>
					<td>总出材量</td>
					<td colspan="2"><input style="width: 300px;border:0px;background-color: transparent;" type="text" id="totaloutwood" name="totaloutwood" value="" /></td>
				</tr>
				<tr>
					<td>施工业绩</td>
					<td colspan="6"><textarea style="height:200px;width:600px;word-break:break-all;border:0px;background-color: transparent;"></textarea></td>
