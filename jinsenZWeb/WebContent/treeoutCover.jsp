...
<main>
    ...
    <div>
    <div class="find-top">
        <p class="p-tail"><i class="i-tail"></i> 该页面是选择销售调令录入木材检尺数据。</p>
    </div>
    <div class="table-con">
...
<script>
    ...
    function table1(){
        $('#table1').bootstrapTable({
            ...
            striped: true,
            singleSelect: false,
            url: "salaryServlet?action=writesale&type=shenhepass",
            data:{},
            dataType: "json",
            pagination: true, //分页
            pageSize: 8,
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (cellval, row) {
                        ...
                        var  d = '<a href="salaryServlet?action=luruJianchi&saleCalloutOrder=\''+ row.saleCalloutOrder + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">录入检尺数据</button></a>';
                ...
                },
                {
                    ...
                    formatter: function (cellval, row) {
                        //var  d = '<a href="workpageSevrlet?action=single&workid=\''+ row.workid + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看</button></a>';
                        var  d = '<a href="salaryServlet?action=finishcorder&saleCalloutOrder=\''+ row.saleCalloutOrder + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">调令完成</button></a>';
                        //var  d = '<a href="workpageSevrlet?action=alldelete&workid=\''+ row.workid + '\'"><button  id="id="delete" data-id="98" class="btn btn-xs btn-primary">删除</button></a>';
                        return  d;
                    }
                },
