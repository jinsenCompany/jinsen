...
<script>
    ...
    function table1(){
        $('#table1').bootstrapTable({
            ...
            singleSelect: false,
            url: "pictureServlet?action=writepage&type=all",
            data:{},
            dataType: "json",
            pagination: true, //分页
            pageSize: 8,
  ...
  <!--  <script type="text/javascript">
    ...
    function notshenhe()
    {
    	...
    	$('#table1').bootstrapTable({
            ...
            singleSelect: false,
            cache: false,//缓存
            url: "pictureServlet?action=writepage&type=notshenhe",
            dataType: "json",
            pagination: true, //分页
            pageSize: 10,
            pageNumber: 1,
...
<script type="text/javascript">
    function pass()
    {
    	...
    	$('#table1').bootstrapTable({
            ...
            singleSelect: false,
            cache: false,//缓存
            url: "pictureServlet?action=writepage&type=pass",
            dataType: "json",
            pagination: true, //分页
            pageSize: 10,
            pageNumber: 1,
    ...
    function notpass()
    {
    	...
    	$('#table1').bootstrapTable({
            ...
            singleSelect: false,
            cache: false,//缓存
            url: "pictureServlet?action=writepage&type=notpass",
            dataType: "json",
            pagination: true, //分页
            pageSize: 10,
            pageNumber: 1,
