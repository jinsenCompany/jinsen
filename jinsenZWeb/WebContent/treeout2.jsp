            ...
            <div>
                <div class="top">
                       ...
                       <tr>
                         ...
                         <tr>
                         <th colspan="2">货场</th>
                        <th colspan="2">检尺标准</th>
                        <th>检尺员</th>
                         </tr>
                         <tr style="font-size:20px">
                            <td colspan="2"><input type="text" name="yard" id="yyard" placeholder="货场"></td>
                             <td colspan="2"><select id="bbratchum" name="batchnum"><option>1-国标</option><option>2-双足码</option><option>3-实码</option></select></td>
                        ...
                        <tr>
                         <td><select id="treetype" name="sss"><option>杉原木</option><option>杉小径</option><option>松原木</option><option>松小径</option><option>杂原木</option><option>杂小径</option></select></td>
