...
<main>
    ...
    <table class="top-table">
     ...
     <tr><td><input style='width: 180px;display:none' id="staff_name" value="<%=staff_name%>"></td></tr>
     <tr><td colspan="10" style="text-align: center"><button class="add-but" onclick="table1()"><i class="glyphicon glyphicon-edit"></i>货场费用汇总</button></td></tr>
      </table>
    </div>
    <div class="table-con">
    <div align="center"><h4 style="color:black;font-weight:bold">当前页面货场费用</h4></div>
