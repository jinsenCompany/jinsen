...
function yardAdd(){
	...
	var yardmanager=$("#yardmanager").val();
	...
	var length=$("#tablesec tr").length;
	 //alert(yardname);
	    for(var id=1;id<=length;id++){
    		var group=[];
    	    group[0]=document.getElementById("section"+id+"").value;
    	    if(group[0]=="")
    	    	{
    	    	alert("请将信息填写完整！");
    	    	}
    ...
    $.ajax({
        ...
        success: function (data) {
        	...
        	if(data>0)
        		{
        	        alert("添加成功！");
        	        window.location.href = 'yardinfoSection.jsp';
        		}
        	else{
        		 alert("添加失败");
        		 window.location.href = 'yardinfoSection.jsp';
...
function addSection()
{
 	...
 	+"货场分区:&nbsp;&nbsp;<span style='font-size:20px;'></span><input type='text' style='width:360px;heigth:100px' name='section' id='section"+k+"' value=''></td></tr>";
             k=Number(k)+Number(1);
            $("#ttt5").append(str);        
}
function dddelete()
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 仪表盘</a>
  <ul>
    ...
    <li class="active"><a href="yardinfo.jsp"><i class="icon icon-home"></i> <span>货场信息管理</span></a></li>
...
<tr><td style="font-size:20pt">&nbsp;&nbsp;&nbsp;&nbsp;货&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;场&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td><td><input class="text" name="yardname" id="yardname"></td></tr>
<tr><td>货场容积(m3、T):&nbsp;&nbsp;</td><td><input class="text" name="yardvolume" id="yardvolume"></td></tr>
<tr><td>货场管理员(、分隔符):</td><td><input class="text" name="yardmanager" id="yardmanager"></td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;联系&nbsp;&nbsp;方式&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td><td><input class="text" name="managephone" id="managephone"></td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td><td><input class="text" name="remarks" id="remarks"></td></tr>
</tbody>
 </table>
...
<div>
 ...
 <div class=" but_p" style="float:center;">
  ...
  <button class="but_save" type="button" onclick="yardAdd()" value="保存货场信息">保存货场信息</button>
