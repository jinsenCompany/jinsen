...
function yes(){
	...
	$.ajax({
		url:"treeServlet?action=inyardyesorno&type=yes",
        //url:"cutnumServlet",
        data:{
...
function not(){
	...
	alert(rejectreason);
	$.ajax({
        url:"treeServlet?action=inyardyesorno&type=not",
        data:{
            ...
            <div id="divprint">
                <div class="top">
                       ...
                       <table class="table1">
                         ...
                         <td>工单号<span></span></td>
                          <td>
                           <input name="workid" type="text" maxlength="32" id="wworkid" readonly value="<fmt:formatNumber value="<%=w.getWorkid()%>" pattern="#0.##"/>" />
                  ...
                  <td><div class=" but_p"><button class="but_save" type="button"  onclick="not()" value="审核未通过">审核未通过 </button>
                  <button class="but_save" id="btnPrint" type="button" value="打印">打印</button></div></td>
                 </tr>
                 </table>
               </form>
            </div>
