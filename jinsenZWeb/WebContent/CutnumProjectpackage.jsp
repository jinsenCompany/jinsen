...
.btn{ 	
	...
	font-size: 22px!important; 	height: 30px; 	
...
<main>
    ...
    <table style="margin:left">
       <tr>
       <td>&nbsp;&nbsp;&nbsp;&nbsp;工程包创建时间:</td><td><input type="text" name="projpackageStarttime" id="projpackageStarttime" value="<%=now%>" readonly="readonly"></td>
       <td>&nbsp;&nbsp;&nbsp;&nbsp;工程包:</td><td><input type="text" name="projectPackageName" id="projectPackageName" placeholder="格式：余坊工程包202001"></td>
    ...
    <div class="1" style="text-align:center">
		    <span  style="text-align: center;"><button style="width:160px;height:50px;" class="btn"  onclick="addproject()" value="保存工程包">保存工程包</button></span>
		 </div>
