...
<script type="text/javascript">
function toggle(table8) {
if (document.getElementById){
 target = document.getElementById(table8);
  if ( target.style.display == "none") {
   target.style.display = ""; 
  } else { 
   target.style.display = "none";
            ...
            <div id="divprint">
                ...
                <p class="table_p"><span>采伐工单信息</span></p>
                       <table class="table1">
                        ...
                        <button  class="btna" type="button"  value="杉木" onclick="toggle('table5');"><span style="font-size:40px">杉木</span></button>
                        ...
                        <table class="table" id="table5" style="width:100%;height:auto;display: none">
                           <tbody id="ttt5">
                            ...
                            <table class="table" id="table6" style="width:100%;height:auto;display: none">
                            <tbody id="ttt6">
                            ...
                            <table class="table" id="table7" style="width:100%;height:auto;display: none">
                           <tbody id="ttt7">
                            ...
                            <table class="table" id="table8" style="width:100%;height:auto;display: none">
                           <tbody id="ttt8">
                            ...
                            <table class="table1" >
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:20px">合计树材<span></span>
                                     ...
                                     <td style="font-size:20px">货场分区<span></span><select style="width:120px; font-size:20px" name="section" id="ssection"><option>A区</option><option>B区</option><option>C区</option><option>D区</option><option>无固定位置</option></select><span></span></td>
                  ...
                  <span><button style="width:120px;heigth:60px" class="btn" type="button"  onclick="treeAdd()" value="提交">提交</button></span>
                 
                 <span><input style="width:120px;heigth:60px" class="btn" type="button" id="btnPrint" value="打印"/>  </span>  </div>
