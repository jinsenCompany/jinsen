...
function mysave()
{
    ...
    $.ajax({
        ...
        success: function (data) {
    		...
    		{
    	        alert("添加成功！");
    	        window.location.href = 'productPrice2.jsp';
    		}
        	else 
        		{
        		alert("添加失败！");
...
<main>
    ...
    <button class="bg_lr" style="width:300px;height:60px;" type="button" onclick="window.location='productPrice23.jsp'"><i class="icon-tint"></i>分径级木材生产结算</button>
    </div>
    <br>
    ...
    <p class="table_p" style="margin-left: 40%;"><span style="font-size:20pt">生产工资结算</span></p>
           <table class="top-table" border="1">
            <tr>
            <td colspan="8" style="width:300px">结算时间：<%=now%></td>
            </tr>
