                         ...
                         <td>工单号<span></span></td>
                          ...
                          <input type="text" name="cutsite" id="ccutsite" value="<%=c.getCutSite() %>">
                           ...
                           <tr>
                              ...
                              <td><select name="section" id="ssection" value="<%=c.getSection()%>"><option>A区</option><option>B区</option><option>C区</option><option>D区</option><option>无固定位置</option></select></td>
                              <td>检尺员<span></span></td>
