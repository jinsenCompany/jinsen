                ...
                <div class="top" id="divprint">
                    <div>
                        <div class="top_out">
                           ...
                           <caption class="book_h01">已通过伐区监管员填写的工单</caption>
                           <tr>
                           <th colspan="2">工单号</th>
                          ...
                          <th colspan="2">采伐时间</th>
                           ...
                           <td colspan="2">
                             ...
                             <tr>
                                ...
                                <td colspan="4"><input type="text" name="forester" id="fforester" value="<%=c.getForester() %>" placeholder="伐区监管员"></td>
                             </tr>
                            </table>
                        </div>
                    </div>
