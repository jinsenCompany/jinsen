...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 仪表盘</a>
  <ul>
    ...
    <li class="active"> <a href="treeoutTable.jsp"><i class="icon icon-th-list"></i>木材销售报表<span></span></a></li>
    <li> <a href="producetreeTable.jsp"><i class="icon icon-inbox"></i> <span>木材产出报表</span></a> </li>
  </ul>
</div>
<!--sidebar-menu-->
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="superManage.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>返回超级管理员首页</a></div>
        ...
        <div class="find-top1">
           ...
           <tr><td colspan="15" style="text-align: center"><button class="add-but" onclick="producetree()"><i class="glyphicon glyphicon-edit"></i>木材销售情况表</button></td></tr>
            </table>
           </div>
           <div class="table-con">
