    ...
    <div class="divprint">
       ...
       <%--  <div id="mysomething">
        <table class="top-table">
          ...
          <tr><td class="top-table-label">工单：</td>
          ...
          <tr>
              ...
              <td><input type="text" disabled="disabled" name="tvolume" id="tvolume"></td>
              <td><input type="text" disabled="disabled" name="unitprice" id="unitprice"></td>
              <td><input type="text" disabled="disabled" name="price" id="price"></td>
          </tr>
      </table>  
      <table class="table" >
                 <tbody>
