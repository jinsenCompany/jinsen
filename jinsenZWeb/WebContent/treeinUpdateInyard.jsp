    ...
    $.ajax({
        ...
        success: function (data) {
        	...
        	if(data>0)
        		{
        	        alert("更新成功！");
        	        window.location.href = 'InyardShenhesu.jsp';
        		}
        	else{
        		 alert("更新失败");
        		 window.location.href = 'InyardShenhesu.jsp';
            ...
            <div id="divprint">
                ...
                <tr>
                 <td style="font-size:20px">未通过审核原因:</td><td><input style="width:400px;font-size:20px" type="text" name="rejectreason" id="rejectreason" value="<%=w.getRejectreason() %>"></td>
                    ...
                    <button class="but_save" type="button"  onclick="treeAdd()" value="更新工单">更新工单</button>
                 <button class="but_save" type="button" value="返回" onclick="javascrtpt:window.location.href='treein.jsp'">返回添加</button>
