...
<main class="all">
    ...
    <div class="find-top1" style="vertical-align:middle">
      <table style="border:0px;align:center;valign:middle" >
		   ...
		   <button class="btn" data-toggle="modal" id="myModal_pass" onclick="pass()">显示已通过工单列表</button> 
		   <button class="btn" data-toggle="modal" id="myModal_notpass" onclick="notpass()">显示未通过工单列表</button>
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (cellval, row) {
                        ...
                        var  d = '<a href="workpageSevrlet?action=faquworkpagePass&workid=\''+ row.workid + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看</button></a><button type="button" data-id="98"  class="btn btn-xs btn-primary" onclick="overtimedelete(\''+ row.workid + '\')">删除</button> ';
  ...
  <!--  <script type="text/javascript">
    ...
    function notshenhe()
    {
    	...
    	$('#table1').bootstrapTable({
            ...
            singleSelect: false,
            cache: false,//缓存
            url: "workpageSevrlet?action=writepage&type=notshenhe",
            dataType: "json",
            pagination: true, //分页
            pageSize: 10,
            pageNumber: 1,
...
<script type="text/javascript">
    	...
    	$('#table1').bootstrapTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    align: 'center',
                    formatter: function (cellval, row) {
                        var  d = '<a href="workpageSevrlet?action=faquworkpagePass&workid=\''+ row.workid + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看</button></a>';
                        //var  d = '<a href="workpageSevrlet?action=faquworkpagePass&workid=\''+ row.workid + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看</button></a><button type="button" data-id="98"  class="btn btn-xs btn-primary" onclick="overtimedelete(\''+ row.workid + '\')">删除</button>';
                        //var  d = '<a href="workpageSevrlet?action=alldelete&workid=\''+ row.workid + '\'"><button  id="id="delete" data-id="98" class="btn btn-xs btn-primary">删除</button></a>';
                        return  d;
                    }
    ...
    function notpass()
    {
    	...
    	$('#table1').bootstrapTable({
            ...
            singleSelect: false,
            cache: false,//缓存
            url: "workpageSevrlet?action=writepage&type=notpass",
            dataType: "json",
            pagination: true, //分页
            pageSize: 20,
            pageNumber: 1,
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (cellval, row) {
                        //var  d = '<a href="workpageSevrlet?action=single&workid=\''+ row.workid + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看</button></a>';
                        var  d = '<a href="workpageSevrlet?action=faquworkpage&workid=\''+ row.workid + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看</button></a><button type="button" data-id="98"  class="btn btn-xs btn-primary" onclick="overtimedelete(\''+ row.workid + '\')">删除</button> ';
                        //var  d = '<a href="workpageSevrlet?action=alldelete&workid=\''+ row.workid + '\'"><button  id="id="delete" data-id="98" class="btn btn-xs btn-primary">删除</button></a>';
                        return  d;
                    }
                },
 ...
 <!--<script type="text/javascript">
    function probuchong()
    {
    	...
    	$('#table1').bootstrapTable({
            ...
            singleSelect: false,
            cache: false,//缓存
            url: "workpageSevrlet?action=writepage&type=buchong",
            dataType: "json",
            pagination: true, //分页
            pageSize: 10,
            pageNumber: 1,
