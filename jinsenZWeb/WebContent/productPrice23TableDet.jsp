...
<%
List<cutnum> c=null;
   c=(List<cutnum>)request.getAttribute("cutCompack");
%>
<%
List<Laowu> t=null;
...
<main>
    ...
    <pre align="center">结算时间：<%=now%></pre>	
           <table class="top-table">
            <tr><p class="table_p" style="margin-left: 40%;"><span style="font-size:20pt">生产工资结算清单</span></p>
            </tr>
            <tr>
            ...
            <td class="top-table-label" colspan="2">货场：</td>
                <td colspan="2"><input type="text" id="yard" name="yard" value="<%=t.get(0).getYard() %>"></td>
                <td class="top-table-label" colspan="2">货场分区：</td>
                <td colspan="2"><input type="text" id="section" name="section" value="<%=t.get(0).getSection() %>"></td>
            </tr>
            </table>
            <br>
            <table class="top-table">
            ...
            <tr>
              <td colspan="8"><input style="width:200px" type="text" name="cutaddress" id="cutaddress" value="<%=c.get(0).getCutaddress() %>">乡(镇)
              <input style="width:200px" type="text" name="cutvillage" id="cutvillage" value="<%=c.get(0).getCutvillage() %>">村
              <input style="width:250px" type="text" name="quartel" id="quartel" value="<%=c.get(0).getQuartel() %>">林班
              <input style="width:200px" type="text" name="largeblock" id="largeblock" value="<%=c.get(0).getLargeblock() %>">大班
              <input style="width:200px" type="text" name="smallblock" id="smallblock" value="<%=c.get(0).getSmallblock() %>">小班</td>
            </tr>
        </table>
        ...
        <th style="text-align: center">树材种</th>
        <th style="text-align: center">长度</th>
        <th style="text-align: center">径级</th>
        <th style="text-align: center">材积</th>
        ...
        <th colspan="2" style="text-align: center">备注</th>
         ...
         <% int i=1;%>
          ...
          <td><input type='text' style='border:0px;background-color: transparent;text-align: center'  value="${b.getTlong()}"></td>
          <td><input type='text' style='border:0px;background-color: transparent;text-align: center'  value="${b.getTradius()}"></td>
        ...
        <tr>
          <td>合计</td>
          <td colspan="3"><input type="text" style="width:120px; font-size:20px" name="ttvolume" id="ttvolume" value="<%=t.get(0).getttvolume() %>">立方米<span></span></td>
          <td  colspan="4"><input type="text" style="width:120px; font-size:20px" name="tprice" id="tprice" value="<%=t.get(0).getTprice() %>">元<span></span></td>
         </tr>
         <tr>
              <td width="150px">注：本批结算单附码单有${worklength}份，码单号如下<br/></td>
              <td colspan="7">
