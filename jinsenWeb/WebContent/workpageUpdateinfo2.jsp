 ...
 .table_p{line-height: 28px;border-bottom: 1px #d0e6ec solid;position: relative;margin-bottom: 10px; 
        ...
        #h a{font-size:15px;width: 230px; height: 30px;padding: 10px 0;text-align: center;  background: #3c763d; display: block; text-decoration:none; color:white}
         ...
         tr{text-align:center}
          .table2{width:80%; height:100px;margin-left:auto; margin-right:auto;padding:10px;border-collapse:collapse}
</style>
...
function yes(){
	...
	$.ajax({
		url:"workpageSevrlet?action=workpageyesorno2&type=yes",
        //url:"cutnumServlet",
        data:{
...
function not(){
	var workid=document.getElementById("wworkid").value;
	$.ajax({
        url:"workpageSevrlet?action=workpageyesorno2&type=not",
        data:{
    ...
    <td style="font-size:20px">未通过审核原因:</td><td><input style="width:400px;font-size:20px" type="text" name="rejectreason" id="rejectreason" value="<%=w.getRejectreason() %>"></td>
                        ...
                        <div class="top_out">
                          ...
                          <th colspan="2">采伐时间</th>
                           ...
                           <td colspan="2">
                              <input style="width:50%;border:0px;background-color: transparent"  name="cutdate" value="<%=c.getCutdate() %>"  id="ccutdate" placeholder="采伐时间">
                           </td>
                           </tr>
                           <tr>
                           ...
                           <td colspan="2">
                             ...
                             <tr>
                                ...
                                <td colspan="4"><input style="width:50%;border:0px;background-color: transparent" type="text" name="forester" id="fforester" value="<%=c.getForester() %>" placeholder="伐区监管员"></td>
                             </tr>
                            </table>
                        </div>
                    </div>
            ...
            <div> 
   <div><p class="table_p" style="margin-top: 65px;font-size:20px"><span>信息中心审核工单</span></p></div>
    ...
    <td><div class=" but_p"><button class="but_save" type="button"  id="btnPrint" value="打印">打印 </button></div></td>
    </tr>
    </table>
