...
<div class="find-top">
     <p class="p-tail"><i class="i-tail"></i> 该页面是检尺费导出页面</p>
</div>
<div class="find-top1">
    <table class="top-table">
     <tr><td class="top-table-label">销售工单号</td><td><input id="workid" name="workid"></tr>
     <tr><td colspan="10" style="text-align: center"><button class="add-but" onclick="searchoutyard()"><i class="glyphicon glyphicon-edit"></i>搜索销售工单信息</button></td></tr>
      </table>
  </div>
 <div class="table-con">
            ...
            columns: [[
                ...
                },
                {
                    ...
                    formatter: function (cellval, row) {
                        ...
                        var  d = '<a href="treeServlet?action=findoutyardCostTable&workid=\''+ row.workid + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看检尺费表</button></a>';
