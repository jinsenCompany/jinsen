...
<main>
    ...
    <div class="find-top1">
    <form onSubmit="return inputNull(this)" action="workpageSevrlet?action=addCancellingStockTable" method="POST">
    <div class="top" id="divprint">
		...
		<caption class="book_h01">退库单</caption>
			...
			<td>上传附件</td><td><input type="file" id="path" name="path" value="" /></td>
			</tr>
			</table>
