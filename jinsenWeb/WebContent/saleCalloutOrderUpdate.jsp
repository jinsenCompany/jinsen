...
<main>
    ...
    <div class=" but_p" style="float:center;">
     <button style="width:150px;height:50px" class="but_save" type="button"  onclick="yes()" value="审核通过">审核通过</button>
     <button style="width:150px;height:50px" class="but_save" type="button"  onclick="not()" value="审核未通过">审核未通过</button>
