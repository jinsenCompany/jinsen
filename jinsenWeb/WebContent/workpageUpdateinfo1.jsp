...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 仪表盘</a>
  <ul>
    <li class="active"><a href="workpageShenheinfo.jsp"><i class="icon icon-home"></i> <span>审核进场工单</span></a> </li>
                    ...
                    <div>
                        <div class="top_out">
                          ...
                          <th colspan="2">时间</th>
                           ...
                           <tr>
                            <td colspan="2">
                              <input style="width:80%;border:0px;background-color: transparent" type="text" name="workid" id="wworkid" value="<%=c.getWorkid() %>" placeholder="工单号">
                           </td>
                           <td colspan="2">
                             <input style="width:80%;border:0px;background-color: transparent" type="text" name="cutnum" id="cccutnum" value="<%=c.getCutNum() %>" placeholder="采伐证号">
                           </td>
                           <td colspan="2">
                           ...
                           <tr>
                           <td colspan="2">
                              <input style="width:80%;border:0px;background-color: transparent" type="text" name="cutsite" id="ccutsite" value="<%=c.getCutSite() %>" placeholder="采伐地点">
                           </td>
                           <td colspan="2">
                              <input style="width:80%;border:0px;background-color: transparent" type="text" name="checksite" id="ccchecksite" value="<%=c.getCheckSite() %>" placeholder="检验地点">
                           </td>
                           <td colspan="2">
                              <input style="width:80%;border:0px;background-color: transparent" type="text" name="carnumber" id="ccarnumber" value="<%=c.getCarNumber() %>" placeholder="车牌号">
                           </td>
                           </tr>
                             ...
                             <tr>
                                <td colspan="2"></td>
                                <td colspan="2"></td>
                                <td colspan="2"><input style="width:80%;border:0px;background-color: transparent" type="text" name="forester" id="fforester" value="<%=c.getForester() %>" ></td>
                             </tr>
                            </table>
                        </div>
                    </div>
...
<div> 
    ...
    <table>
    <tr>
    <td style="font-size:20px">请输入未通过审核原因:</td><td><input style="width:400px;font-size:20px" type="text" name="rejectreason" id="rejectreason"></td>
    <td><div class=" but_p"><button class="but_save" type="button"  onclick="not()" value="审核未通过">审核未通过 </button></div></td>
    <td><div class=" but_p"><button style="float:right;" type="button" id="btnPrint" value="打印">打印</button></div></td>
    </tr>
    </table>
</div>
</form>    
