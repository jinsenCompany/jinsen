...
<main>
    ...
    <p class="table_p"><span>树材信息录入</span></p>
      ...
      <table style="margin-left:auto; margin-right:auto">
      <tr>
      <td>交货地点</td><td><input type="text" name="deliveryplace" id="deliveryplace"></td>
      <td>数量</td><td><input type="text" name="treenumber" id="treenumber"></td>
      <td>费用负担</td><td><input type="text" name="cost" id="cost"></td>
      <td>检尺标准</td><td><select id="measurestard" name="measurestard"><option>1-国标</option><option>2-双足码</option><option>3-实码</option></select></td>
      </tr>
      <tr>
      ...
      <td>保证金</td><td><input type="text" name="margin" id="margin"></td>     
      </tr>
      <tr>
