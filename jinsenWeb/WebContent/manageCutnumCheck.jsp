...
<script>
    ...
    function table1(){
            $('#table1').bootstrapTable({
                ...
                striped: true,
                singleSelect: false,
                url: "cutnumServlet?action=findCutnumCheck",
                data:{},
                dataType: "json",
                pagination: true, //分页
                pageSize: 8,
            ...
            columns: [[
                ...
                
                {
                    ...
                    formatter: function (cellval, row) {
                        ...
                        var  d = '<a href="cutnumServlet?action=watchCheck&cutnum=\''+ row.cutnum + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">生产管理</button></a>';
